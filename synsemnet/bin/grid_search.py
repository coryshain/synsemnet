...
if __name__ == '__main__':
    argparser = argparse.ArgumentParser('''
        ...
        For example, to search over STS decoder types vs. covarying encoder sizes, the following
        ...
        This will create a 2 x 3 search over STS decoder types vs. number and size of encoder layers -- i.e. 2 layers
        with 32 units each, 3 layers with 64 units each, and 4 layers with 128 units each.
    ''')
